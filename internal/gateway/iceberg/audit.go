...
// into a Cypher MERGE/MATCH body. Mirrors internal/ingest's
// escapeCypher exactly — duplicated here to avoid a cross-package
// dependency on the ingest package (the gateway should not depend on
// ingest for a string helper).
