...
--   • idx_<Label>_tenant — btree on (properties->>'tenant_id') — required for
--     RLS policy performance (V0030 references this same expression).
...
CREATE INDEX IF NOT EXISTS idx_Table_tenant         ON neksur."Table"         USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Table_props_gin      ON neksur."Table"         USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Column_tenant        ON neksur."Column"        USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Column_props_gin     ON neksur."Column"        USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Snapshot_tenant      ON neksur."Snapshot"      USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Snapshot_props_gin   ON neksur."Snapshot"      USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Metric_tenant        ON neksur."Metric"        USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Metric_props_gin     ON neksur."Metric"        USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Dimension_tenant     ON neksur."Dimension"     USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Dimension_props_gin  ON neksur."Dimension"     USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_View_tenant          ON neksur."View"          USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_View_props_gin       ON neksur."View"          USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Dashboard_tenant     ON neksur."Dashboard"     USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Dashboard_props_gin  ON neksur."Dashboard"     USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Pipeline_tenant      ON neksur."Pipeline"      USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Pipeline_props_gin   ON neksur."Pipeline"      USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Query_tenant         ON neksur."Query"         USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Query_props_gin      ON neksur."Query"         USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Person_tenant        ON neksur."Person"        USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Person_props_gin     ON neksur."Person"        USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Team_tenant          ON neksur."Team"          USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Team_props_gin       ON neksur."Team"          USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Policy_tenant        ON neksur."Policy"        USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Policy_props_gin     ON neksur."Policy"        USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_GlossaryTerm_tenant   ON neksur."GlossaryTerm" USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_GlossaryTerm_props_gin ON neksur."GlossaryTerm" USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Tag_tenant           ON neksur."Tag"           USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Tag_props_gin        ON neksur."Tag"           USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_DataContract_tenant   ON neksur."DataContract" USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_DataContract_props_gin ON neksur."DataContract" USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Engine_tenant        ON neksur."Engine"        USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Engine_props_gin     ON neksur."Engine"        USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_Catalog_tenant       ON neksur."Catalog"       USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_Catalog_props_gin    ON neksur."Catalog"       USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_WriteEvent_tenant    ON neksur."WriteEvent"    USING btree ((properties->>'tenant_id'));
CREATE INDEX IF NOT EXISTS idx_WriteEvent_props_gin ON neksur."WriteEvent"    USING GIN (properties);

CREATE INDEX IF NOT EXISTS idx_DetectionRun_tenant   ON neksur."DetectionRun" USING btree ((properties->>'tenant_id'));
